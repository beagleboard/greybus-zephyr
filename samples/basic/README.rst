...
1. **Dummy Transport**
   ...
   .. code-block:: bash
      ...
      west build -b beagleconnect_freedom@C7/cc1352p7 samples/greybus/basic \
...
These are build-only tests verified on the ``beagleconnect_freedom@C7/cc1352p7`` platform.
